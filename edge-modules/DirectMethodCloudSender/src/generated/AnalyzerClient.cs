...
namespace DirectMethodCloudSender
{
    ...
    public partial class AnalyzerClient 
    {
        ...
        /// <summary>Add a new response status</summary>
        /// <param name="body">Response status details</param>
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task AddResponseStatusAsync(ResponseStatus body)
        {
            return AddResponseStatusAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task AddResponseStatusAsync(ResponseStatus body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/respponsestatus");
