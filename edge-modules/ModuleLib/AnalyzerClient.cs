...
namespace Microsoft.Azure.Devices.Edge.ModuleUtil
{
    ...
    public partial class AnalyzerClient 
    {
        ...
        /// <summary>Add a new twin status</summary>
        /// <param name="body">Twin status details</param>
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task AddTwinStatusAsync(ResponseStatus body)
        {
            return AddTwinStatusAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task AddTwinStatusAsync(ResponseStatus body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/twinstatus");
        ...
        /// <summary>Add a new direct method status</summary>
        /// <param name="body">Direct method status details</param>
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task AddDirectMethodStatusAsync(ResponseStatus body)
        {
            return AddDirectMethodStatusAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task AddDirectMethodStatusAsync(ResponseStatus body, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/directmethodstatus");
    ...
    public partial class ResponseStatus 
    {
        ...
        [Newtonsoft.Json.JsonProperty("enqueuedDateTime", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
