namespace Microsoft.Azure.Devices.Edge.Azure.Monitor
{
    public static class Constants
    {
        ...
        public const string DefaultLogAnalyticsWorkspaceDomainPrefixOds = ".ods.opsinsights.";
        public const string DefaultLogAnalyticsWorkspaceDomainPrefixOms = ".oms.opsinsights.";
