...
This release supercedes v1.2.37. It syncs to a newer commit in 'main' that contains important changes to our test pipelines. There are not changes to the Metrics Collector product code.
