...
pub struct Check {
    ...
    expected_aziot_edge_agent_image_id: Option<String>,
    expected_aziot_edge_hub_image_id: Option<String>,
...
impl Check {
    pub fn new(
        ...
        Check {
            ...
            expected_aziot_edge_agent_image_id,
            expected_aziot_edge_hub_image_id,
            output_format,
            verbose,
            warnings_as_errors,
            aziot_bin,
