        ...
        match identity {
            aziot_identity_common::Identity::Aziot(identity) => {
                let module_id = match identity.module_id {
                    ...
                    None => {
                        return Err(edgelet_http::error::bad_request("missing parameter: module id"));
                    }
                };
                ...
                let generation_id = match identity.gen_id {
                    ...
                    None => {
                        return Err(edgelet_http::error::bad_request("missing parameter: generation id"));
                    }
                };
            ...
            _ => Err(edgelet_http::error::bad_request("invalid parameter: identity type")),
        }
    }
}
