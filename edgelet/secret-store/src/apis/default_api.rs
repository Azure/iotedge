...
pub trait DefaultApi {
    fn delete_secret(&self, api_version: &str, id: &str) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn get_secret(&self, api_version: &str, id: &str) -> Box<Future<Item = String, Error = Error<serde_json::Value>>>;
    fn pull_secret(&self, api_version: &str, id: &str, akv_uri: &str) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn refresh_secret(&self, api_version: &str, id: &str) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
    fn set_secret(&self, api_version: &str, id: &str, value: &str) -> Box<Future<Item = (), Error = Error<serde_json::Value>>>;
}
