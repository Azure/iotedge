        ...
        context: &C) -> Result<DeleteSecretResponse, ApiError>
    {
        ...
        let query_string = {
            let mut query_string = form_urlencoded::Serializer::new("".to_owned());
                query_string.append_pair("api-version",
        ...
        match response.status().as_u16() {
            ...
            404 => {
                ...
                Ok(DeleteSecretResponse::NotFound
                    (body)
                )
            }
            0 => {
        ...
        match response.status().as_u16() {
            ...
            400 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::ErrorResponse>(body)?;
                Ok(RefreshSecretResponse::NoSource
                    (body)
                )
            }
            404 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::ErrorResponse>(body)?;
                Ok(RefreshSecretResponse::NotFound
                    (body)
                )
            }
            0 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))?;
                let body = serde_json::from_str::<models::ErrorResponse>(body)?;
                Ok(RefreshSecretResponse::Error
                    (body)
                )
            }
            code => {
