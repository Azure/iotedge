...
const char* const ENV_REGISTRATION_ID = "IOTEDGE_REGISTRATIONID";
const char* const ENV_DEVICE_CERTIFICATE_PATH = "IOTEDGE_DEVICE_ID_CERT";
const char* const ENV_DEVICE_PRIVATE_KEY_PATH = "IOTEDGE_DEVICE_ID_PK";
