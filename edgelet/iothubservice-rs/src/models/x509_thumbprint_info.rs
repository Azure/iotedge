...
impl X509ThumbprintInfo {
    pub fn new() -> X509ThumbprintInfo {
        X509ThumbprintInfo {
    ...
    pub fn with_primary_thumbprint(mut self, primary_thumbprint: String) -> X509ThumbprintInfo {
        self.primary_thumbprint = Some(primary_thumbprint);
        self
    }
    ...
    pub fn with_secondary_thumbprint(mut self, secondary_thumbprint: String) -> X509ThumbprintInfo {
        self.secondary_thumbprint = Some(secondary_thumbprint);
        self
    }
