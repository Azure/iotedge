...
pub struct TaskStatus {
    ...
    state: Option<crate::models::TaskState>,
    ...
    container_status: Option<crate::models::TaskStatusContainerStatus>,
}
...
impl TaskStatus {
    ...
    pub fn set_state(&mut self, state: crate::models::TaskState) {
    ...
    pub fn state(&self) -> Option<&crate::models::TaskState> {
        self.state.as_ref()
    }
    ...
    pub fn container_status(&self) -> Option<&crate::models::TaskStatusContainerStatus> {
