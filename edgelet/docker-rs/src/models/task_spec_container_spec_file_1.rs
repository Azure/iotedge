...
impl TaskSpecContainerSpecFile1 {
    ...
    pub fn with_name(mut self, name: String) -> TaskSpecContainerSpecFile1 {
        self.name = Some(name);
        self
    }
    ...
    pub fn with_UID(mut self, UID: String) -> TaskSpecContainerSpecFile1 {
        self.UID = Some(UID);
        self
    }
    ...
    pub fn with_GID(mut self, GID: String) -> TaskSpecContainerSpecFile1 {
        self.GID = Some(GID);
        self
    }
    ...
    pub fn with_mode(mut self, mode: i32) -> TaskSpecContainerSpecFile1 {
        self.mode = Some(mode);
        self
    }
