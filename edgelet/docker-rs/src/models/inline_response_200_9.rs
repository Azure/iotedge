...
pub struct InlineResponse2009 {
    ...
    images_deleted: Option<Vec<crate::models::ImageDeleteResponseItem>>,
...
impl InlineResponse2009 {
    ...
    pub fn images_deleted(&self) -> Option<&[crate::models::ImageDeleteResponseItem]> {
        self.images_deleted.as_ref().map(AsRef::as_ref)
    }

    pub fn reset_images_deleted(&mut self) {
        self.images_deleted = None;
    }

    pub fn set_space_reclaimed(&mut self, space_reclaimed: i64) {
