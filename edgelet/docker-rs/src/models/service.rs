...
impl Service {
    ...
    pub fn set_spec(&mut self, spec: ::models::ServiceSpec) {
        self.spec = Some(spec);
    }
    ...
    pub fn spec(&self) -> Option<&::models::ServiceSpec> {
        self.spec.as_ref()
    }
    ...
    pub fn set_endpoint(&mut self, endpoint: ::models::ServiceEndpoint) {
    ...
    pub fn endpoint(&self) -> Option<&::models::ServiceEndpoint> {
    ...
    pub fn set_update_status(&mut self, update_status: ::models::ServiceUpdateStatus) {
    ...
    pub fn update_status(&self) -> Option<&::models::ServiceUpdateStatus> {
