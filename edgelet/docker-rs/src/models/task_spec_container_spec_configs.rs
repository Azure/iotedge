...
pub struct TaskSpecContainerSpecConfigs {
    ...
    file: Option<crate::models::TaskSpecContainerSpecFile1>,
...
impl TaskSpecContainerSpecConfigs {
    ...
    pub fn set_file(&mut self, file: crate::models::TaskSpecContainerSpecFile1) {
        self.file = Some(file);
    }
    ...
    pub fn file(&self) -> Option<&crate::models::TaskSpecContainerSpecFile1> {
        self.file.as_ref()
    }
