...
pub struct SecretCreateBody {
    ...
    driver: Option<crate::models::Driver>,
}
...
impl SecretCreateBody {
    ...
    pub fn set_driver(&mut self, driver: crate::models::Driver) {
    ...
    pub fn driver(&self) -> Option<&crate::models::Driver> {
        self.driver.as_ref()
    }
