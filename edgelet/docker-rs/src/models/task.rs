...
impl Task {
    ...
    pub fn set_spec(&mut self, spec: ::models::TaskSpec) {
        self.spec = Some(spec);
    }
    ...
    pub fn spec(&self) -> Option<&::models::TaskSpec> {
        self.spec.as_ref()
    }
    ...
    pub fn assigned_generic_resources(&self) -> Option<&::models::GenericResources> {
    ...
    pub fn set_status(&mut self, status: ::models::TaskStatus) {
    ...
    pub fn status(&self) -> Option<&::models::TaskStatus> {
        self.status.as_ref()
    }
    ...
    pub fn set_desired_state(&mut self, desired_state: ::models::TaskState) {
    ...
    pub fn desired_state(&self) -> Option<&::models::TaskState> {
