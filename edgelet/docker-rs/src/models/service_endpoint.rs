...
impl ServiceEndpoint {
    ...
    pub fn set_spec(&mut self, spec: ::models::EndpointSpec) {
        self.spec = Some(spec);
    }
    ...
    pub fn spec(&self) -> Option<&::models::EndpointSpec> {
        self.spec.as_ref()
    }
    ...
    pub fn set_virtual_i_ps(&mut self, virtual_i_ps: Vec<::models::ServiceEndpointVirtualIPs>) {
