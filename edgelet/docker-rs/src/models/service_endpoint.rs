...
pub struct ServiceEndpoint {
    ...
    virtual_i_ps: Option<Vec<crate::models::ServiceEndpointVirtualIPs>>,
}
...
impl ServiceEndpoint {
    ...
    pub fn set_spec(&mut self, spec: crate::models::EndpointSpec) {
        self.spec = Some(spec);
    }
    ...
    pub fn spec(&self) -> Option<&crate::models::EndpointSpec> {
        self.spec.as_ref()
    }
    ...
    pub fn virtual_i_ps(&self) -> Option<&[crate::models::ServiceEndpointVirtualIPs]> {
        self.virtual_i_ps.as_ref().map(AsRef::as_ref)
    }

    pub fn reset_virtual_i_ps(&mut self) {
        self.virtual_i_ps = None;
    }
}
