...
pub struct Secret {
    ...
    spec: Option<crate::models::SecretSpec>,
}
...
impl Secret {
    ...
    pub fn set_spec(&mut self, spec: crate::models::SecretSpec) {
        self.spec = Some(spec);
    }

    pub fn with_spec(mut self, spec: crate::models::SecretSpec) -> Self {
        self.spec = Some(spec);
        self
    }

    pub fn spec(&self) -> Option<&crate::models::SecretSpec> {
        self.spec.as_ref()
    }
