...
pub struct TaskSpecPlacementPreferences {
    ...
    spread: Option<crate::models::TaskSpecPlacementSpread>,
}
...
impl TaskSpecPlacementPreferences {
    ...
    pub fn set_spread(&mut self, spread: crate::models::TaskSpecPlacementSpread) {
    ...
    pub fn spread(&self) -> Option<&crate::models::TaskSpecPlacementSpread> {
        self.spread.as_ref()
    }
