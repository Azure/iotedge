...
pub struct GenericResourcesInner {
    ...
    named_resource_spec: Option<crate::models::GenericResourcesInnerNamedResourceSpec>,
    #[serde(
        rename = "DiscreteResourceSpec",
        skip_serializing_if = "Option::is_none"
    )]
    discrete_resource_spec: Option<crate::models::GenericResourcesInnerDiscreteResourceSpec>,
}
...
impl GenericResourcesInner {
    ...
    pub fn set_named_resource_spec(
        &mut self,
    ...
    pub fn named_resource_spec(
        &self,
    ) -> Option<&crate::models::GenericResourcesInnerNamedResourceSpec> {
        self.named_resource_spec.as_ref()
    }

    pub fn reset_named_resource_spec(&mut self) {
        self.named_resource_spec = None;
    }

    pub fn set_discrete_resource_spec(
        &mut self,
    ...
    pub fn discrete_resource_spec(
        &self,
    ) -> Option<&crate::models::GenericResourcesInnerDiscreteResourceSpec> {
        self.discrete_resource_spec.as_ref()
    }

    pub fn reset_discrete_resource_spec(&mut self) {
        self.discrete_resource_spec = None;
    }
}
