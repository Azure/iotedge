...
pub struct Swarm {
    ...
    join_tokens: Option<crate::models::JoinTokens>,
}
...
impl Swarm {
    ...
    pub fn set_join_tokens(&mut self, join_tokens: crate::models::JoinTokens) {
    ...
    pub fn join_tokens(&self) -> Option<&crate::models::JoinTokens> {
