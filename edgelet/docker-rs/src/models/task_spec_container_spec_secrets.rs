...
impl TaskSpecContainerSpecSecrets {
    ...
    pub fn set_file(&mut self, file: crate::models::TaskSpecContainerSpecFile) {
        self.file = Some(file);
    }
    ...
    pub fn file(&self) -> Option<&crate::models::TaskSpecContainerSpecFile> {
        self.file.as_ref()
    }
    ...
    pub fn set_secret_id(&mut self, secret_id: String) {
