...
impl InlineResponse20020 {
    ...
    pub fn set_descriptor(&mut self, descriptor: ::models::InlineResponse20020Descriptor) {
    ...
    pub fn descriptor(&self) -> &::models::InlineResponse20020Descriptor {
        &self.descriptor
    }

    pub fn set_platforms(&mut self, platforms: Vec<::models::InlineResponse20020Platforms>) {
