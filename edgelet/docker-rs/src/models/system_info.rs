...
impl SystemInfo {
    ...
    pub fn set_plugins(&mut self, plugins: ::models::PluginsInfo) {
    ...
    pub fn plugins(&self) -> Option<&::models::PluginsInfo> {
        self.plugins.as_ref()
    }
    ...
    pub fn set_registry_config(&mut self, registry_config: ::models::RegistryServiceConfig) {
    ...
    pub fn registry_config(&self) -> Option<&::models::RegistryServiceConfig> {
    ...
    pub fn runtimes(&self) -> Option<&::std::collections::HashMap<String, ::models::Runtime>> {
    ...
    pub fn set_swarm(&mut self, swarm: ::models::SwarmInfo) {
    ...
    pub fn swarm(&self) -> Option<&::models::SwarmInfo> {
        self.swarm.as_ref()
    }
    ...
    pub fn set_containerd_commit(&mut self, containerd_commit: ::models::Commit) {
    ...
    pub fn containerd_commit(&self) -> Option<&::models::Commit> {
    ...
    pub fn set_runc_commit(&mut self, runc_commit: ::models::Commit) {
    ...
    pub fn runc_commit(&self) -> Option<&::models::Commit> {
    ...
    pub fn set_init_commit(&mut self, init_commit: ::models::Commit) {
    ...
    pub fn init_commit(&self) -> Option<&::models::Commit> {
