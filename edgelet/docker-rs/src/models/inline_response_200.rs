...
impl InlineResponse200 {
    ...
    pub fn set_state(&mut self, state: ::models::InlineResponse200State) {
    ...
    pub fn state(&self) -> Option<&::models::InlineResponse200State> {
        self.state.as_ref()
    }
    ...
    pub fn set_mounts(&mut self, mounts: Vec<::models::MountPoint>) {
    ...
    pub fn set_network_settings(&mut self, network_settings: ::models::NetworkSettings) {
    ...
    pub fn network_settings(&self) -> Option<&::models::NetworkSettings> {
