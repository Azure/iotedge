...
pub struct TaskSpecPlacement {
    ...
    preferences: Option<Vec<crate::models::TaskSpecPlacementPreferences>>,
    ...
    platforms: Option<Vec<crate::models::Platform>>,
}
...
impl TaskSpecPlacement {
    ...
    pub fn preferences(&self) -> Option<&[crate::models::TaskSpecPlacementPreferences]> {
    ...
    pub fn set_platforms(&mut self, platforms: Vec<crate::models::Platform>) {
    ...
    pub fn platforms(&self) -> Option<&[crate::models::Platform]> {
