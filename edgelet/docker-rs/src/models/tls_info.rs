...
pub struct TlsInfo {
    ...
    #[serde(
        rename = "CertIssuerSubject",
        skip_serializing_if = "Option::is_none"
    )]
    cert_issuer_subject: Option<String>,
    /// The base64-url-safe-encoded raw public key bytes of the issuer
    #[serde(
        rename = "CertIssuerPublicKey",
        skip_serializing_if = "Option::is_none"
    )]
...
impl TlsInfo {
    ...
    pub fn set_trust_root(&mut self, trust_root: String) {
    ...
    pub fn set_cert_issuer_subject(&mut self, cert_issuer_subject: String) {
    ...
    pub fn reset_cert_issuer_subject(&mut self) {
        self.cert_issuer_subject = None;
    }

    pub fn set_cert_issuer_public_key(&mut self, cert_issuer_public_key: String) {
    ...
    pub fn reset_cert_issuer_public_key(&mut self) {
        self.cert_issuer_public_key = None;
    }
}
