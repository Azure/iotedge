...
mkdir -p $BUILD_DIR
COMMAND="cd /project/edgelet && make deb8 VERSION=${VERSION} CARGOFLAGS=\"--target armv7-unknown-linux-gnueabihf\" TARGET=target/armv7-unknown-linux-gnueabihf/release DPKGFLAGS=\"-b -us -uc -i --host-arch armhf\""
