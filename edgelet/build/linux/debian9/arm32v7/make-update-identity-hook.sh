...
mkdir -p "$BUILD_DIR"
COMMAND="cd /project/edgelet && make release KUBE_CARGOFLAGS=\"--manifest-path ./Cargo.toml --target armv7-unknown-linux-gnueabihf\" TARGET=target/armv7-unknown-linux-gnueabihf/release"
