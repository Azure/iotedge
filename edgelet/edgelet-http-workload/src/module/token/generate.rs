    ...
    M: edgelet_core::ModuleRuntime + Send + Sync,
{
    ...
    fn from_uri(
        ...
        let uri_regex = regex::Regex::new("^/modules/(?P<moduleId>[^/]+)/token/generate$")
    ...
    async fn get(self) -> http_common::server::RouteResponse {
        ...
        let expiry = expiry.as_secs() + super::TOKEN_EXPIRY_TIME_SECONDS;

        self.api.generate_token(self.module_id, expiry).await
    }
