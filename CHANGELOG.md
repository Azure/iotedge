...
The 1.6 version is the latest long-term servicing (LTS) release for Azure IoT Edge. It will be serviced with fixes for regressions and critical security issues through November 14, 2028 ([product lifecycle](https://learn.microsoft.com/en-us/lifecycle/products/azure-iot-edge)).

## Edge Agent
* Update Azure IoT SDKs ( [36d6c42](https://github.com/Azure/iotedge/commit/36d6c426bb66d17e18619432b58496b407bff0bf) )
* Upgrade to .NET 10 ( [0e32eab](https://github.com/Azure/iotedge/commit/0e32eab34acd76c53655469a7ee6fbdea59787c1) )
...
* Block the ability to created nested derived keys ( [b36c9a3](https://github.com/Azure/iot-identity-service/commit/b36c9a322497e012a9942fd7c231e3769167e038) )
