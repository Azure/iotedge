...
| `edgehub_client_connect_failed_total`                              | `id` (Module ID)<br> `reason` (not authenticated)<br> `protocol` (MQTT, AMQP, HTTP) <br>| Total number of times clients failed to connect to edgeHub                                                                                                                                                                        | counter |                                                              
