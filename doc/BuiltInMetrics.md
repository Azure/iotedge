...
| `edgehub_connected_clients`                              	  | 															 												| Current number of connected clients to edge hub        					| gauge |                                                            
| `edgehub_client_connect_success_total`                      | `id` (Device/Module ID)<br>																					| Total number of times individual client successfully connect to edgeHub   | counter |                                                                                                                                                                    | counter |                                                              
