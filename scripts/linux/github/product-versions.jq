...
# Return an array of product objects from all channels that match the given product name and version
def products($product_name; $product_version):
[ product_iter($product_name; $product_version) ];
...
# Return a new JSON object which includes new "aziot-edge" product entries. The new entries will be copies of the
