...
process_args()
{
    ...
    if[[ "azureiotedge-module-base-rocksdb" != ${DOCKER_IMAGENAME} ]] && [[ "azureiotedge-module-base" != ${DOCKER_IMAGENAME} ]] && [[ "azureiotedge-hub-base" != ${DOCKER_IMAGENAME} ]] && [[ "azureiotedge-agent-base" != ${DOCKER_IMAGENAME} ]] && [[ "azureiotedge-iotedged-base" != ${DOCKER_IMAGENAME} ]] && [[ "azureiotedge-proxy-base" != ${DOCKER_IMAGENAME} ]]; then
        echo "Docker image name must be one of azureiotedge-module-base, azureiotedge-module-base-rocksdb, azureiotedge-hub-base, azureiotedge-agent-base, azureiotedge-iotedged-base or azureiotedge-proxy-base"
        print_help_and_exit
    fi
