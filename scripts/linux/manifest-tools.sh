...
#   REPOSITORY      Required. The image repository to which the manifest will be pushed
#   REFERENCE       Required. The tag or digest for which the manifest will be pushed
...
#   PLATFORM_MAP    Optional. A JSON object that defines the mapping of platforms to tag suffixes. Default:
#                   [
#                       {
...
copy_platform_specific_manifests() {
    ...
    do
        ...
        REFERENCE="$tag" MANIFEST="$manifest" push_manifest
