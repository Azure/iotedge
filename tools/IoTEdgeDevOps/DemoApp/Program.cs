...
namespace DemoApp
{
    ...
    class Program
    {
        // private static ConsoleEventListener _listener = new ConsoleEventListener("Microsoft-Azure-");
        ...
        static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                Environment.SetEnvironmentVariable("IOTEDGE_IOTHUBHOSTNAME", "");
                ...
                Environment.SetEnvironmentVariable("MODULE_NAME", "");
