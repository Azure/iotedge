    ...
    public static class BuildExtension
    {
        public static HashSet<BuildDefinitionId> BuildDefinitions =>
            new HashSet<BuildDefinitionId>
            {
                ...
                BuildDefinitionId.NestedLonghaulNonBrokerTest,
                BuildDefinitionId.NestedLonghaulWithBrokerTest,
        ...
        static Dictionary<BuildDefinitionId, string> definitionIdToDisplayNameMapping = new Dictionary<BuildDefinitionId, string>
        {
            ...
            { BuildDefinitionId.NestedLonghaulNonBrokerTest, "Nested Longhaul Test (non-broker)" },
            { BuildDefinitionId.NestedLonghaulWithBrokerTest, "Nested Longhaul Test (broker)" },
