...
namespace DevOpsLib
{
    ...
    public class BugManagement
    {
        ...
        public async Task<string> CreateBugAsync(string branch, VstsBuild build)
        {
            ...
            (string bugOwnerFullName, string bugOwnerEmail) = await GetBugOwnerInfoAsync(build.SourceVersion);
        ...
        string GenerateBugDescription(string bugOwnerFullName, string bugOwnerEmail, VstsBuild build)
        {
