// ATTENTION: This file is autogenerated, but the retry policy related logic was
// added on top. If we need to regenerate this file please port that modification.
//
//----------------------
// <auto-generated>
...
namespace Microsoft.Azure.Devices.Edge.ModuleUtil
{
    ...
    public partial class TestResultReportingClient
    {
        ...
        private static RetryStrategy RetryStrategy = new ExponentialBackoff(3, TimeSpan.FromMilliseconds(100), TimeSpan.FromSeconds(3), TimeSpan.Zero, false);
        private static RetryPolicy retryPolicy = new RetryPolicy(new AnyErrorDetectionStrategy(), RetryStrategy);
        ...
        public async System.Threading.Tasks.Task ReportResultAsync(TestOperationResultDto body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var response_ = await retryPolicy.ExecuteAsync(
                        async () =>
                        {
                            var response = await client_.SendAsync(request_, System.Net.Http.HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false);
                            return response;
                        }, cancellationToken);
    ...
    class AnyErrorDetectionStrategy : ITransientErrorDetectionStrategy
    {
