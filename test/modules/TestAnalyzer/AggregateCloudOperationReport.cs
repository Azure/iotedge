...
namespace TestAnalyzer
{
    ...
    class AggregateCloudOperationReport
    {
        ...
        bool IsPassedHelper()
        {
            ...
            double allStatusCount = this.StatusCodes.Select(s => s.Count).Sum();
            bool statusCodeZeroBelowThreshold = this.StatusCodes.Where(s => s.StatusCode.Equals("0")).Count() < (allStatusCount / 100);
