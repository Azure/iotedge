...
namespace Microsoft.Azure.Devices.Edge.Test.DirectMethod
{
    ...
    [Command(
        Name = "direct-method",
        Description = "Module-to-module direct method test",
        ExtendedHelpText = @"
...
")]
    ...
    class Program
    {
        ...
        [Required]
        [Option("--method-sender", Description = "Method sender image name")]
        public string SenderImage { get; }

        [Required]
        [Option("--method-receiver", Description = "Method receiver image name")]
        public string ReceiverImage { get; }
