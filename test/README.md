...
| `parentEdgeDevice` || parent edge device ID to enable connection to parent edge device in nested edge scenario. Required when running nested edge tests, ignored otherwise. |
