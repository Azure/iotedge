...
| `rootCaCertificatePath` || Full path to the root certificate used by the transparent gateway tests. For the CA tests in particular, this certificate should have already been registered in your IoT hub (see the [tutorial](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-security-x509-get-started#register-x509-ca-certificates-to-your-iot-hub)). |
