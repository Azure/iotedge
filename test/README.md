...
| `[E2E_]PREVIEW_IOT_HUB_CONNECTION_STRING` | * | Hub-scoped IoT Hub connection string in the Central EUAP region for preview testing - required only for PlugAndPlay tests. |
...
| `[E2E_]PREVIEW_EVENT_HUB_ENDPOINT` | * | Event hub in the Central EUAP region, for preview testing - required only for PlugAndPlay tests. |
