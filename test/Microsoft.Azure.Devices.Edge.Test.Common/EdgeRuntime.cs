...
namespace Microsoft.Azure.Devices.Edge.Test.Common
{
    ...
    public class EdgeRuntime
    {
            ...
            bool nestedEdge)
        {
            ...
            if (nestedEdge == true)
            {
                hubEnvVar = new[] { ("RuntimeLogLevel", "debug"), ("experimentalFeatures__enabled", "true"), ("experimentalFeatures__nestedEdgeEnabled", "true"), ("experimentalFeatures__EnableMqttBroker", "true") };
            }
            else
            {
