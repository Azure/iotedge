...
namespace Microsoft.Azure.Devices.Edge.Test.Common.Linux
{
    ...
    public class OsPlatform : Common.OsPlatform, IOsPlatform
    {
        ...
        public IEdgeDaemon CreateEdgeDaemon(Option<string> _, Option<string> bootstrapAgentImage, Option<Registry> bootstrapRegistry) => EdgeDaemon.CreateAsync(bootstrapAgentImage, bootstrapRegistry).Result;
