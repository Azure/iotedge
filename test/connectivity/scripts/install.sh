...
function install_and_setup_iotedge() {
    ...
    device_ca_cert_path="/certs/certs/certs/certs/iot-edge-device-${device_name}-edge-full-chain.cert.pem"
    device_ca_pk_path="/certs/certs/certs/private/iot-edge-device-${device_name}-edge.key.pem"
