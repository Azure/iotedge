...
2. Connectivity test can be run by calling [Connectivity Test script](https://github.com/Azure/iotedge/blob/release/1.1/test/connectivity/scripts/connectivityTest.sh).
