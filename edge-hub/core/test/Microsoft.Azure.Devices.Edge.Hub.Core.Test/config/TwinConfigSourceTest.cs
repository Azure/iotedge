...
namespace Microsoft.Azure.Devices.Edge.Hub.Core.Test.Config
{
    ...
    public class TwinConfigSourceTest
    {
        ...
        public void ValidateTwinSignature(string type, string schemaVersion, string algo, string[] signercert, string[] intermediatecacert, string signature)
        {
        ...
        public static IEnumerable<object[]> GetTwinForVerifyingSignatures()
        {
            ...
            string ecdsaSignature = "SQG8DZxbNkLqpcBeaa1EgfPcukqHkmWLahbNwv6xLxEyXQle8/gOFnzbR6GBzan++fMe2EI9l0b0QWtFbxAZCA==";
