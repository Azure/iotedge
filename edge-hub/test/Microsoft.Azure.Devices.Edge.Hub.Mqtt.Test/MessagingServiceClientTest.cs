...
namespace Microsoft.Azure.Devices.Edge.Hub.Mqtt.Test
{
    ...
    public class MessagingServiceClientTest
    {
        ...
        public async Task TestReceiveMessagingChannelComplete()
        {
            ...
            var deviceListner = new DeviceMessageHandler(MockIdentity, EdgeHub.Object, connectionManager.Object, DefaultMessageResponseTimeout);
