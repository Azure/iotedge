...
namespace Microsoft.Azure.Devices.Edge.Hub.Mqtt.Test
{
    ...
    public class DeviceIdentityProviderTest
    {
            ...
            Type expectedType)
        {
            ...
            var deviceIdentityProvider = new DeviceIdentityProvider(authenticator.Object, new ClientCredentialsFactory(new IdentityProvider(iotHubHostName)), metadataStore, true);
            if (certificate != null)
            {
        ...
        public async Task GetIdentityCertAuthNotEnabled()
        {
            ...
            var deviceIdentityProvider = new DeviceIdentityProvider(authenticator.Object, new ClientCredentialsFactory(new IdentityProvider(iotHubHostName)), metadataStore, false);
