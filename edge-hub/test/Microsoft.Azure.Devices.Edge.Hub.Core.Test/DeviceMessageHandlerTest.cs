...
namespace Microsoft.Azure.Devices.Edge.Hub.Core.Test
{
    ...
    public class DeviceMessageHandlerTest
    {
        ...
        public async Task ForwardsGetTwinOperationToEdgeHub()
        {
            ...
            var listener = new DeviceMessageHandler(identity, edgeHub.Object, connMgr, DefaultMessageResponseTimeout);
        ...
        public async Task ProcessMessageBatchAsync_RouteAsyncTest()
        {
            ...
            var deviceListener = new DeviceMessageHandler(identity, edgeHub, connectionManager, DefaultMessageResponseTimeout);
        ...
        public async Task MessageCompletionTest()
        {
            ...
            var deviceMessageHandler = new DeviceMessageHandler(identity, edgeHub, connMgr.Object, DefaultMessageResponseTimeout);
