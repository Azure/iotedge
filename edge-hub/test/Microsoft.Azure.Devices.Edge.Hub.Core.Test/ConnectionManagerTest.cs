...
namespace Microsoft.Azure.Devices.Edge.Hub.Core.Test
{
    ...
    public class ConnectionManagerTest
    {
        ...
        public async Task TestAddRemoveDeviceConnectionTest()
        {
            ...
            var cloudConnectionProvider = new CloudConnectionProvider(messageConverterProvider, 1, deviceClientProvider.Object, Option.None<UpstreamProtocol>(), TimeSpan.FromMinutes(60));
        ...
        public async Task AddRemoveSubscriptionsTest()
        {
            ...
            // Act
            await connectionManager.AddDeviceConnection(deviceCredentials);
            connectionManager.BindDeviceProxy(identity, Mock.Of<IDeviceProxy>(d => d.IsActive));
