...
namespace Microsoft.Azure.Devices.Edge.Hub.Core.Test
{
    ...
    public class IdentityProviderTest
    {
        ...
        {
            yield return new object[] { "foo.azure-device.net", "d1", new DeviceIdentity("foo.azure-device.net", Option.None<string>(), "d1") };
            yield return new object[] { "foo.azure-device.net", "d1/m1", new ModuleIdentity("foo.azure-device.net", Option.None<string>(), "d1", "m1") };
        }

        public static IEnumerable<object[]> GetCreateTestParameters2()
        {
            yield return new object[] { "foo.azure-device.net", "d1", string.Empty, new DeviceIdentity("foo.azure-device.net", Option.None<string>(), "d1") };
            yield return new object[] { "foo.azure-device.net", "d1", "m1", new ModuleIdentity("foo.azure-device.net", Option.None<string>(), "d1", "m1") };
        }
    }
}
