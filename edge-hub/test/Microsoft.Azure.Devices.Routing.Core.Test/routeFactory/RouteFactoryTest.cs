...
namespace Microsoft.Azure.Devices.Routing.Core.Test.RouteFactory
{
    ...
    public class RouteFactoryTest
    {
        ...
        [InlineData(@"FORM /* INTO brokeredEndpoint(""/modules/alertLogic/inputs/in')")]
        [InlineData(@"FORM /messages INTO brokeredEndpoint('/modules/alertLogic/inputs/in"")")]
        [InlineData(@"FORM /* INTO brokeredEndpoint('/modules/alert""Logic/inputs/in')")]
        [InlineData(@"FORM /messages INTO brokeredEndpoint(""/modules/alert'Logic/inputs/in"")")]
