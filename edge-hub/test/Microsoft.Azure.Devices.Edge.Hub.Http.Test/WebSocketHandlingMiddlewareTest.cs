...
namespace Microsoft.Azure.Devices.Edge.Hub.Http.Test
{
    ...
    public class WebSocketHandlingMiddlewareTest
    {
        ...
        public async Task ProducesANewCorrelationIdForEachWebSocketRequest()
        {
            ...
            IWebSocketListenerRegistry registry = this.ObservingWebSocketListenerRegistry(correlationIds);
            ...
            return Mock.Of<HttpContext>(
                ctx =>
                    ...
                    ctx.Connection == Mock.Of<ConnectionInfo>(
                        conn => conn.LocalIpAddress == new IPAddress(123) && conn.LocalPort == It.IsAny<int>()
        ...
        IWebSocketListenerRegistry ObservingWebSocketListenerRegistry(List<string> correlationIds)
        {
