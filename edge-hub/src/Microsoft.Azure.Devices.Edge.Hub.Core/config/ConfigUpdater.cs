...
namespace Microsoft.Azure.Devices.Edge.Hub.Core.Config
{
    ...
    public class ConfigUpdater
    {
        ...
        private ConfigUpdater(Router router, IMessageStore messageStore, TimeSpan configUpdateFrequency, IStorageSpaceChecker storageSpaceChecker, Option<EdgeHubConfig> initialConfig)
        {
