...
namespace Microsoft.Azure.Devices.Edge.Storage.RocksDb.Test
{
    ...
    public class RockDbWrapperTest
    {
        ...
        public void CreateWithNullOptionThrowsAsync()
        {
            ...
            // Act
            // Assert
            Assert.Throws<ArgumentNullException>(() => RocksDbWrapper.Create(null, "AnyPath", partitions, false));
            partitions.Clear();
        }
        ...
        public void CreateWithNullPathThrowsAsync()
        {
            ...
            // Act
            // Assert
            Assert.Throws<ArgumentException>(() => RocksDbWrapper.Create(options, null, partitions, false));
            partitions.Clear();
        }
        ...
        public void CreateWithNullPartitionsPathThrowsAsync()
        {
            ...
            // Act
            // Assert
            Assert.Throws<ArgumentNullException>(() => RocksDbWrapper.Create(options, "AnyPath", null, false));
        }
    }
}
