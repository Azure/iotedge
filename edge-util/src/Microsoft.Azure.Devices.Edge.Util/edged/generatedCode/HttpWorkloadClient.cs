...
#pragma warning disable // Disable all warnings
    ...
    public partial class HttpWorkloadClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="IoTEdgedException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<EncryptResponse> EncryptAsync(string api_version, string name, EncryptRequest payload)
        {
            return EncryptAsync(api_version, name, payload, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="IoTEdgedException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<EncryptResponse> EncryptAsync(string api_version, string name, EncryptRequest payload, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/modules/{name}/encrypt?");
            urlBuilder_.Replace("{name}", System.Uri.EscapeDataString(ConvertToString(name, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Append("api-version=").Append(System.Uri.EscapeDataString(ConvertToString(api_version, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
        ...
        /// <returns>OK</returns>
        /// <exception cref="IoTEdgedException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<DecryptResponse> DecryptAsync(string api_version, string name, DecryptRequest payload)
        {
            return DecryptAsync(api_version, name, payload, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="IoTEdgedException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<DecryptResponse> DecryptAsync(string api_version, string name, DecryptRequest payload, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/modules/{name}/decrypt?");
            urlBuilder_.Replace("{name}", System.Uri.EscapeDataString(ConvertToString(name, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Append("api-version=").Append(System.Uri.EscapeDataString(ConvertToString(api_version, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
    ...
    public partial class EncryptRequest : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// <summary>An optional passphrase used to encrypt the data.</summary>
    ...
    public partial class EncryptResponse : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// <summary>The encrypted form of the data.</summary>
    ...
    public partial class DecryptRequest : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// <summary>An optional passphrase used to decrypt the data.</summary>
        [Newtonsoft.Json.JsonProperty("passphrase", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public byte[] Passphrase
        {
            get { return _passphrase; }
    ...
    public partial class DecryptResponse : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        /// <summary>The decrypted form of the data.</summary>
        [Newtonsoft.Json.JsonProperty("plaintext", Required = Newtonsoft.Json.Required.Always)]
        public byte[] Plaintext
        {
            get { return _plaintext; }
