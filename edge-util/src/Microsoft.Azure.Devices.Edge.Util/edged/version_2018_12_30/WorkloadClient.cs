...
namespace Microsoft.Azure.Devices.Edge.Util.Edged.Version_2018_12_30
{
    using System;
    using System.Net.Http;
    using System.Text;
    using System.Threading.Tasks;
    using Microsoft.Azure.Devices.Edge.Util.Edged.Version_2018_12_30.GeneratedCode;
    using Microsoft.Azure.Devices.Edge.Util.TransientFaultHandling;

    class WorkloadClient : WorkloadClientVersioned
    {
        public WorkloadClient(Uri serverUri, ApiVersion apiVersion, string moduleId, string moduleGenerationId) : base(serverUri, apiVersion, moduleId, moduleGenerationId, new ErrorDetectionStrategy())
        {
        }
