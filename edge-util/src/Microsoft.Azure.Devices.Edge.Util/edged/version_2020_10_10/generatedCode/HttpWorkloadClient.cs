...
#pragma warning disable // Disable all warnings
    ...
    public partial class HttpWorkloadClient
    {
        ...
        /// <returns>Ok</returns>
        /// <exception cref="IoTEdgedException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<ValidateTokenResponse> ValidateTokenAsync(string api_version, string name, string genid, ValidateTokenRequest payload)
        {
            return ValidateTokenAsync(api_version, name, payload, System.Threading.CancellationToken.None);
        }
        ...
        public async System.Threading.Tasks.Task<ValidateTokenResponse> ValidateTokenAsync(string api_version, string name, ValidateTokenRequest payload, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/modules/{name}/token/validate?");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            ...
                            var result_ = default(ValidateTokenResponse);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<ValidateTokenResponse>(responseData_, _settings.Value);
                                return result_;
                            }
                        ...
                        return default(ValidateTokenResponse);
                    }
                    finally
                    {
                        if (response_ != null)
    ...
    public partial class ValidateTokenRequest : System.ComponentModel.INotifyPropertyChanged
    {
        private string _token;

        /// <summary>Token which needs to be validated</summary>
        ...
        public static ValidateTokenRequest FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ValidateTokenRequest>(data);
        }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.4.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class ValidateTokenResponse : System.ComponentModel.INotifyPropertyChanged
    {
        private string _token;
        ...
        public static ValidateTokenResponse FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<ValidateTokenResponse>(data);
        }
