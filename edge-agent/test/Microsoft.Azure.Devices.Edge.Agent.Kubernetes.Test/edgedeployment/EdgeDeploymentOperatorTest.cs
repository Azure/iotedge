...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes.Test.EdgeDeployment
{
    ...
    public class EdgeDeploymentOperatorTest
    {
        ...
        public void CtsIsCancelledOnRestartFailure()
        {
            ...
            var client = Mock.Of<IKubernetes>();
            Mock.Get(client).Setup(c => c.ListNamespacedCustomObjectWithHttpMessagesAsync(Constants.EdgeDeployment.Group, Constants.EdgeDeployment.Version, DeviceNamespace, Constants.EdgeDeployment.Plural, It.IsAny<bool?>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int?>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int?>(), true, It.IsAny<string>(), null, It.IsAny<CancellationToken>()))
