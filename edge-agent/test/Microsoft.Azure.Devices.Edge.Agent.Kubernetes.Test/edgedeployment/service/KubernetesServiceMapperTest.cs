...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes.Test.EdgeDeployment.Service
{
    ...
    public class KubernetesServiceMapperTest
    {
        ...
        static readonly ModuleIdentity CreateIdentity = new ModuleIdentity("hostname", "edgedevicehostname", Option.None<string>(), "device1", "Module1", new ConnectionStringCredentials("connection string"));
