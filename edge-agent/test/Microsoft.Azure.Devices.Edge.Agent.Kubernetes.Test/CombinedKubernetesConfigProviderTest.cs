...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes.Test
{
    ...
    public class CombinedKubernetesConfigProviderTest
    {
        ...
        public void IgnoresKubernetesCreateOptionsWhenExperimentalDisabled()
        {
            ...
            var module = new Mock<IModule<DockerConfig>>();
            module.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", ExperimentalCreateOptions, Option.None<string>()));
    ...
    ""nodeSelector"": {
      ...
      ""gpu"": ""true""
        ...
        public void MakesKubernetesAwareAuthConfig()
        {
            ...
            var module = new Mock<IModule<DockerConfig>>();
            module.SetupGet(m => m.Config).Returns(new DockerConfig("docker.io/nginx:latest", (string)null, Option.None<string>()));
            module.SetupGet(m => m.Name).Returns("mod1");
        ...
        public void NoExecArgumentMeansNoExecArguments()
        {
            ...
            var module = new Mock<IModule<DockerConfig>>();
            module.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", string.Empty, Option.None<string>()));
            module.SetupGet(m => m.Name).Returns("mod1");
...
""Cmd"" : [
  ...
  ""argument2""
        ...
        public void CmdEntryOptionsWillExist()
        {
            ...
            var module = new Mock<IModule<DockerConfig>>();
            module.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", CmdCreateOptions, Option.None<string>()));
            module.SetupGet(m => m.Name).Returns("mod1");
...
""WorkingDir"" : ""a-directory""
        ...
        public void WorkingDirOptionsWillExist()
        {
            ...
            var module = new Mock<IModule<DockerConfig>>();
            module.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", WorkingDirCreateOptions, Option.None<string>()));
            module.SetupGet(m => m.Name).Returns("mod1");
...
""Cmd"" : {
  ""argument1"":  ""argument2""
        ...
        public void InvalidCmdEntryOptionsThrows()
        {
            ...
            var module = new Mock<IModule<DockerConfig>>();
            module.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", InvalidCmdCreateOptions, Option.None<string>()));
            module.SetupGet(m => m.Name).Returns("mod1");
...
""Entrypoint"" : ""a-command""
        ...
        public void InvalidEntrypointOptionsThrows()
        {
            ...
            var module = new Mock<IModule<DockerConfig>>();
            module.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", InvalidEntryPointCreateOptions, Option.None<string>()));
            module.SetupGet(m => m.Name).Returns("mod1");
...
""WorkingDir"" : [ ""/tmp/working"" ]
        ...
        public void InvalidWorkingDirOptionsThrows()
        {
            ...
            var module = new Mock<IModule<DockerConfig>>();
            module.SetupGet(m => m.Config).Returns(new DockerConfig("nginx:latest", InvalidWorkingDirCreateOptions, Option.None<string>()));
            module.SetupGet(m => m.Name).Returns("mod1");
