...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes.Test
{
    ...
    public class KubernetesDeploymentMapperTest
    {
        ...
        {
            var identity = new ModuleIdentity("hostname", "edgedevicehostname", Option.None<string>(), "deviceid", "Module1", Mock.Of<ICredentials>());
        ...
        {
            var identity = new ModuleIdentity("hostname", "edgedevicehostname", Option.None<string>(), "deviceid", "$edgeAgent", Mock.Of<ICredentials>());
            var config = new KubernetesConfig("image", CreatePodParameters.Create(), Option.Some(new AuthConfig("user-registry1")));
