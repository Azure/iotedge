...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes.Test
{
    ...
    public class EdgeDeploymentCommandTest
    {
        ...
        public void Constructor_ThrowsException_OnInvalidParams()
        {
            ...
            IModule m1 = new DockerModule("module1", "v1", ModuleStatus.Running, Core.RestartPolicy.Always, Config1, ImagePullPolicy.OnCreate, Core.Constants.DefaultPriority, DefaultConfigurationInfo, EnvVars, Secrets);
        ...
        {
            IModule dockerModule = new DockerModule("module1", "v1", ModuleStatus.Running, Core.RestartPolicy.Always, Config1, ImagePullPolicy.OnCreate, Core.Constants.DefaultPriority, DefaultConfigurationInfo, EnvVars, Secrets);
        ...
        {
            IModule dockerModule1 = new DockerModule("module1", "v1", ModuleStatus.Running, Core.RestartPolicy.Always, Config1, ImagePullPolicy.OnCreate, Core.Constants.DefaultPriority, DefaultConfigurationInfo, EnvVars, Secrets);
            IModule dockerModule2 = new DockerModule("module2", "v1", ModuleStatus.Running, Core.RestartPolicy.Always, Config2, ImagePullPolicy.OnCreate, Core.Constants.DefaultPriority, DefaultConfigurationInfo, EnvVars, Secrets);
            var dockerConfigProvider = new Mock<ICombinedConfigProvider<CombinedDockerConfig>>();
        ...
        public async void Execute_PreservesCaseOfEnvVars_WhenModuleDeployed()
        {
            ...
            IModule dockerModule = new DockerModule("module1", "v1", ModuleStatus.Running, Core.RestartPolicy.Always, Config1, ImagePullPolicy.OnCreate, Core.Constants.DefaultPriority, DefaultConfigurationInfo, moduleEnvVars, Secrets);
            var dockerConfigProvider = new Mock<ICombinedConfigProvider<CombinedDockerConfig>>();
            dockerConfigProvider.Setup(cp => cp.GetCombinedConfig(dockerModule, Runtime))
                .Returns(() => new CombinedDockerConfig("test-image:1", Config1.CreateOptions, Option.None<string>(), Option.Maybe(DockerAuth)));
            var configProvider = new Mock<ICombinedConfigProvider<CombinedKubernetesConfig>>();
