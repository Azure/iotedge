...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes.Test
{
    ...
    public class KubernetesEnvironmentOperatorTest
    {
        ...
        public void CtsIsCancelledOnRestartFailure()
        {
            ...
            Mock.Get(client).Setup(c => c.ListNamespacedPodWithHttpMessagesAsync(DeviceNamespace, It.IsAny<bool?>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int?>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int?>(), true, It.IsAny<string>(), null, It.IsAny<CancellationToken>()))
                .Throws(listingError);
