...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes.Test
{
    ...
    public class KubernetesEnvironmentOperatorTest
    {
        ...
        public void CtsIsCancelledOnRestartFailure()
        {
            ...
            Mock.Get(client).Setup(c => c.ListNamespacedPodWithHttpMessagesAsync(DeviceNamespace, null, null, null, null, null, null, null, It.IsAny<int?>(), true, null, null, It.IsAny<CancellationToken>()))
                .Throws(listingError);
