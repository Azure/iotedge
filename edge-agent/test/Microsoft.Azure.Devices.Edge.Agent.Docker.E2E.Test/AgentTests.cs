    ...
    public class AgentTests
    {
        ...
        public async Task AgentStartsUpModules(TestConfig testConfig)
        {
            ...
            try
            {
                ...
                moduleIdentityLifecycleManager.Setup(m => m.GetModuleIdentitiesAsync(It.IsAny<ModuleSet>(), It.IsAny<ModuleSet>(), It.IsAny<bool>())).Returns(Task.FromResult(identities));
