...
namespace Microsoft.Azure.Devices.Edge.Agent.IoTHub.Test
{
    ...
    public class ModuleIdentityLifecycleManagerTest
    {
        ...
        public async Task TestGetModulesIdentity_WithUpdatedModules_NoServiceIdentity_ShouldCreateIdentities()
        {
            ...
            var module = new TestModule(Name, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, EnvVars);
        ...
        public async Task TestGetModulesIdentity_WithRemovedModules_ShouldRemove()
        {
            ...
            var currentModule = new TestModule(Name, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, EnvVars);
        ...
        public async Task TestGetModulesIdentity_EdgeHubTest()
        {
            ...
            var testMod = new TestModule(Name, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, EnvVars);
            var edgeHubMod = new TestModule(Constants.EdgeHubModuleName, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.Always, PullPolicy.IfNotPresent, DefaultConfigurationInfo, EnvVars);
