...
namespace Microsoft.Azure.Devices.Edge.Agent.IoTHub.Test
{
    ...
    public class ModuleIdentityLifecycleManagerTest
    {
        ...
        public async Task TestGetModulesIdentity_EdgeHubTest()
        {
            ...
            var testMod = new TestModule(Name, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, ImagePullPolicy.OnCreate, Constants.DefaultStartupOrder, DefaultConfigurationInfo, EnvVars);
            var edgeHubMod = new TestModule(Constants.EdgeHubModuleName, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.Always, ImagePullPolicy.OnCreate, Constants.DefaultStartupOrder, DefaultConfigurationInfo, EnvVars);
