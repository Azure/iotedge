...
namespace Microsoft.Azure.Devices.Edge.Agent.IoTHub.Test.Stream
{
    ...
    public class LogsStreamRequestHandlerTest
    {
        ...
        public async Task HandleTest()
        {
            ...
            runtimeInfoProvider.Setup(r => r.GetModuleLogs(id, true, Option.None<int>(), Option.None<string>(), Option.None<string>(), Option.None<string>(), It.IsAny<CancellationToken>()))
