...
namespace Microsoft.Azure.Devices.Edge.Agent.Core.Test.Planners
{
    ...
    public class HealthRestartPlannerTest
    {
        ...
        public async void TestAddRunningModule()
        {
            ...
            IModule addModule = new TestModule("mod1", "version1", "test", ModuleStatus.Running, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars);
        ...
        public async void TestAddStoppedModule()
        {
            ...
            IModule addModule = new TestModule("mod1", "version1", "test", ModuleStatus.Stopped, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars);
            IImmutableDictionary<string, IModuleIdentity> moduleIdentities = GetModuleIdentities(new List<IModule>() { addModule });
            ModuleSet addRunning = ModuleSet.Create(addModule);
            var addExecutionList = new List<TestRecordType>
            {
        ...
        public async void TestUpdateModule()
        {
            ...
            IRuntimeModule currentModule = new TestRuntimeModule(
                ...
                DateTime.MinValue,
                ModuleStatus.Running);
            IModule desiredModule = new TestModule("mod1", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars);
        ...
        public async Task CreateShutdownPlanTest()
        {
            ...
            IModule module1 = new TestModule("mod1", "version1", "test", ModuleStatus.Running, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars);
            IModule edgeAgentModule = new TestModule(Constants.EdgeAgentModuleName, "version1", "test", ModuleStatus.Running, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars);
        ...
        static (IRuntimeModule RunningModule, IModule UpdatedModule)[] GetUpdateDeployTestData() => new (IRuntimeModule RunningModule, IModule UpdatedModule)[]
        {
            ...
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule1", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Always, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    "updateDeployModule2",
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule2", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Always, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    "updateDeployModule3",
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule3", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Always, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    "updateDeployModule4",
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule4", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Always, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    "updateDeployModule5",
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule5", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Always, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            ...
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule6", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    "updateDeployModule7",
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule7", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    "updateDeployModule8",
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule8", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    "updateDeployModule9",
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule9", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule10", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            ...
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule11", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnFailure, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule12", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnFailure, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule13", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnFailure, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule14", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnFailure, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule15", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.OnFailure, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            ...
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule16", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Never, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule17", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Never, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule18", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Never, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule19", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Never, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
            (
                new TestRuntimeModule(
                    ...
                    null,
                    EnvVars),
                new TestModule("updateDeployModule20", "version1", "test", ModuleStatus.Running, Config2, RestartPolicy.Never, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            ),
        };
