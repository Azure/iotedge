...
namespace Microsoft.Azure.Devices.Edge.Agent.Core.Test.Planners
{
    ...
    public class RestartPlannerTest
    {
        ...
        public async void RestartPlannerAdd1StoppedModule()
        {
            ...
            IModule stoppedModule = new TestModule("mod1", "version1", "test", ModuleStatus.Stopped, Config2, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars);
        ...
        public async void RestartPlannerUpdate1Module()
        {
            ...
            IModule currentModule = new TestModule("mod1", "version1", "test", ModuleStatus.Running, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars);
        ...
        public async void RestartPlannerRemove1Module()
        {
            ...
            IModule removeModule = new TestModule("mod1", "version1", "test", ModuleStatus.Running, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars);
        ...
        public async void RestartPlannerAddRemoveUpdate()
        {
            ...
            {
                new TestModule("NewMod1", "version1", "test", ModuleStatus.Running, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars),
                new TestModule("NewMod2", "version1", "test", ModuleStatus.Stopped, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars),
                new TestModule("UpdateMod1", "version1", "test", ModuleStatus.Running, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars),
                new TestModule("UpdateMod2", "version1", "test", ModuleStatus.Stopped, Config1, RestartPolicy.OnUnhealthy, PullPolicy.Always, DefaultConfigurationInfo, EnvVars)
            };
