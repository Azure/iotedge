    ...
    public class AgentTests
    {
        ...
        public async void ReconcileAsyncOnEmptyPlan()
        {
            ...
            var deploymentConfig = new DeploymentConfig(
                ...
                {
                    { "mod1", new TestModule("mod1", "1.0", "docker", ModuleStatus.Running, new TestConfig("boo"), RestartPolicy.OnUnhealthy, PullPolicy.None, new ConfigurationInfo("1"), null) }
                });
        ...
        public async void ReconcileAsyncReportsFailedWhenEncryptProviderThrows()
        {
            ...
            var desiredModule = new TestModule("desired", "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.None, new ConfigurationInfo("1"), null);
        ...
        {
            var desiredModule = new TestModule("desired", "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.None, new ConfigurationInfo("1"), null);
            var currentModule = new TestModule("current", "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.None, new ConfigurationInfo("1"), null);
            var recordKeeper = Option.Some(new TestPlanRecorder());
        ...
        public async Task HandleShutdownTest()
        {
            ...
            IModule mod1 = new TestModule("mod1", "1.0", "docker", ModuleStatus.Running, new TestConfig("boo"), RestartPolicy.OnUnhealthy, PullPolicy.None, new ConfigurationInfo("1"), null);
            IModule mod2 = new TestModule("mod2", "1.0", "docker", ModuleStatus.Running, new TestConfig("boo"), RestartPolicy.OnUnhealthy, PullPolicy.None, new ConfigurationInfo("1"), null);
