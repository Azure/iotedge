...
namespace Microsoft.Azure.Devices.Edge.Agent.Core.Test.ConfigSources
{
    ...
    public class FileBackupConfigSourceTest : IDisposable
    {
        ...
        static readonly IEdgeAgentModule EdgeAgentModule = new TestAgentModule("edgeAgent", "test", new TestConfig("edge-agent"), PullPolicy.None, ConfigurationInfo, EnvVars);
        ...
        static readonly IModule ValidModule1 = new TestModule("mod1", "version1", "test", ModuleStatus.Running, Config1, RestartPolicy.OnUnhealthy, PullPolicy.None, ConfigurationInfo, EnvVars);
        static readonly IEdgeHubModule EdgeHubModule = new TestHubModule("edgeHub", "test", ModuleStatus.Running, new TestConfig("edge-hub:latest"), RestartPolicy.Always, PullPolicy.None, ConfigurationInfo, EnvVars);
