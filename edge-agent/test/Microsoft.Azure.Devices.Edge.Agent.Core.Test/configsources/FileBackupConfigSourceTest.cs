...
namespace Microsoft.Azure.Devices.Edge.Agent.Core.Test.ConfigSources
{
    ...
    public class FileBackupConfigSourceTest : IDisposable
    {
        ...
        static readonly IEdgeAgentModule EdgeAgentModule = new TestAgentModule("edgeAgent", "test", new TestConfig("edge-agent"), PullPolicy.Always, ConfigurationInfo, EnvVars);
