...
namespace Microsoft.Azure.Devices.Edge.Agent.Core.Test.ConfigSources
{
    ...
    public class FileBackupConfigSourceTest : IDisposable
    {
        ...
        static readonly IEdgeAgentModule EdgeAgentModule = new TestAgentModule("edgeAgent", "test", new TestConfig("edge-agent"), PullPolicy.IfNotPresent, ConfigurationInfo, EnvVars);
        ...
        static readonly IModule ValidModule1 = new TestModule("mod1", "version1", "test", ModuleStatus.Running, Config1, RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, ConfigurationInfo, EnvVars);
