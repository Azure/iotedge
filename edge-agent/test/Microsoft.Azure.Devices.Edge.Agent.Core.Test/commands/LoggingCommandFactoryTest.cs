...
namespace Microsoft.Azure.Devices.Edge.Agent.Core.Test.Commands
{
    ...
    public class LoggingCommandFactoryTest
    {
        ...
        static readonly TestModule TestModule = new TestModule("module", "version", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, EnvVars);
        static readonly TestModule UpdateModule = new TestModule("module", "version", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, EnvVars);
