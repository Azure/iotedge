...
namespace Microsoft.Azure.Devices.Edge.Agent.Core.Test.Commands
{
    ...
    public class NullCommandFactoryTest
    {
        ...
        public async void NullCommandFactoryAllTestAsync()
        {
            ...
            var nm = new TestModule("null", "version_null", "null", ModuleStatus.Running, new TestConfig("null"), RestartPolicy.OnUnhealthy, PullPolicy.None, new ConfigurationInfo(), envVars);
            var nmn = new TestModule("next", "version_null", "null", ModuleStatus.Running, new TestConfig("null"), RestartPolicy.OnUnhealthy, PullPolicy.None, new ConfigurationInfo(), envVars);
