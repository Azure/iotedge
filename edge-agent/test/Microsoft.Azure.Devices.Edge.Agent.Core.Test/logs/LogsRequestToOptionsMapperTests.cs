...
namespace Microsoft.Azure.Devices.Edge.Agent.Core.Test.Logs
{
    ...
    public class LogsRequestToOptionsMapperTests
    {
        ...
        public static IEnumerable<object[]> GetIdsToProcessTestData()
        {
            ...
            var logOptions3 = new ModuleLogOptions(LogsContentEncoding.None, LogsContentType.Text, new ModuleLogFilter(Option.Some(100), Option.None<int>(), Option.None<int>(), Option.None<string>()), LogOutputFraming.None, Option.None<LogsOutputGroupingConfig>(), false);
