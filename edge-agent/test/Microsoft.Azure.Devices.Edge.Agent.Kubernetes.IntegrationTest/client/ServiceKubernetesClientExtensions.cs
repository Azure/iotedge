...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes.IntegrationTest.Client
{
    ...
    public static class ServiceKubernetesClientExtensions
    {
        ...
        public static void DeleteService(this KubernetesClient client, string moduleName) => client.Kubernetes.DeleteNamespacedService(moduleName, client.DeviceNamespace);
    }
}
