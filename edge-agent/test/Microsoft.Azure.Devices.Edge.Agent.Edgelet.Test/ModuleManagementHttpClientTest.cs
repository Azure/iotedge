...
namespace Microsoft.Azure.Devices.Edge.Agent.Edgelet.Test
{
    ...
    public class ModuleManagementHttpClientTest : IClassFixture<EdgeletFixture>
    {
        ...
        {
            // Arrange
            var client = new Version_2018_06_28.ModuleManagementHttpClient(this.serverUrl, 111, Option.Some(TimeSpan.FromSeconds(10)));
        ...
        {
            // Arrange
            var client = new Version_2019_01_30.ModuleManagementHttpClient(this.serverUrl, 111, Option.Some(TimeSpan.FromSeconds(10)));
            await this.ExecuteTimeoutTest_Version_Base(client);
        }
        ...
        {
            // Arrange
            var client = new Version_2019_10_22.ModuleManagementHttpClient(this.serverUrl, 111, Option.Some(TimeSpan.FromSeconds(10)));
            await this.ExecuteTimeoutTest_Version_Base(client);
        }
