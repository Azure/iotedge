...
namespace Microsoft.Azure.Devices.Edge.Agent.Edgelet.Test
{
    ...
    public class ModuleManagementHttpClientTest : IClassFixture<EdgeletFixture>
    {
        ...
        readonly int clientPermitTimeout = 300;
        ...
        public void VersioningTest()
        {
            ...
            var versionedClient = ModuleManagementHttpClient.GetVersionedModuleManagement(this.serverUrl, serverApiVersion, clientApiVersion, Option.None<TimeSpan>());
            ...
            versionedClient = ModuleManagementHttpClient.GetVersionedModuleManagement(this.serverUrl, serverApiVersion, clientApiVersion, Option.None<TimeSpan>());
            Assert.True(versionedClient is Version_2018_06_28.ModuleManagementHttpClient);
            ...
            Assert.Throws<InvalidOperationException>(() => new ModuleManagementHttpClient(this.serverUrl, serverApiVersion, clientApiVersion, Option.None<TimeSpan>(), this.clientPermitTimeout));
        }
        ...
        {
            ModuleManagementHttpClient mm = new ModuleManagementHttpClient(this.serverUrl, serverApiVersion, clientApiVersion, Option.None<TimeSpan>(), this.clientPermitTimeout);
        ...
        {
            // Arrange
            IIdentityManager client = new ModuleManagementHttpClient(this.serverUrl, serverApiVersion, clientApiVersion, Option.None<TimeSpan>(), this.clientPermitTimeout);
        ...
        {
            // Arrange
            IModuleManager client = new ModuleManagementHttpClient(this.serverUrl, serverApiVersion, clientApiVersion, Option.None<TimeSpan>(), this.clientPermitTimeout);
        ...
        {
            // Arrange
            IDeviceManager client = new ModuleManagementHttpClient(this.serverUrl, serverApiVersion, clientApiVersion, Option.None<TimeSpan>(), this.clientPermitTimeout);
        ...
        public async Task ExecuteTimeoutTest_Version_2018_06_28()
        {
            ...
            string serverApiVersion = "2018-06-28";
            string clientApiVersion = "2018-06-28";
            var client = ModuleManagementHttpClient.GetVersionedModuleManagement(this.serverUrl, serverApiVersion, clientApiVersion, Option.Some(TimeSpan.FromSeconds(10)));
        ...
        {
            // Arrange
            string serverApiVersion = "2019-01-30";
            string clientApiVersion = "2019-01-30";
            var client = ModuleManagementHttpClient.GetVersionedModuleManagement(this.serverUrl, serverApiVersion, clientApiVersion, Option.Some(TimeSpan.FromSeconds(10)));
            await this.ExecuteTimeoutTest_Version_Base(client);
        }
        ...
        {
            // Arrange
            string serverApiVersion = "2019-10-22";
            string clientApiVersion = "2019-10-22";
            var client = ModuleManagementHttpClient.GetVersionedModuleManagement(this.serverUrl, serverApiVersion, clientApiVersion, Option.Some(TimeSpan.FromSeconds(10)));
            await this.ExecuteTimeoutTest_Version_Base(client);
        }
