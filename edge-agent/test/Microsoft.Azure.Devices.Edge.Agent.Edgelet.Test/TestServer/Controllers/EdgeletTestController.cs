...
namespace Microsoft.Azure.Devices.Edge.Agent.Edgelet.Test.TestServer.Controllers
{
    ...
    public interface IController
    {
        ...
        System.Threading.Tasks.Task<Identity> UpdateIdentityAsync(string api_version, IdentitySpec identity);

        /// <summary>Create an identity.</summary>
        /// <param name="api_version">The version of the API.</param>
        /// <param name="name">The name of the identity to create. (urlencoded)</param>
        /// <returns>Created</returns>
        System.Threading.Tasks.Task<Identity> CreateIdentityAsync(string api_version, string name);
    ...
    public partial class Controller : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        /// <param name="identity"></param>
        /// <returns>Updated</returns>
        [Microsoft.AspNetCore.Mvc.HttpPut, Microsoft.AspNetCore.Mvc.Route("identities/")]
        public System.Threading.Tasks.Task<Identity> UpdateIdentity(string api_version, [Microsoft.AspNetCore.Mvc.FromBody] IdentitySpec identity)
        {
            return _implementation.UpdateIdentityAsync(api_version, identity);
        }
        ...
        /// <param name="name">The name of the identity to create. (urlencoded)</param>
        /// <returns>Created</returns>
        [Microsoft.AspNetCore.Mvc.HttpPost, Microsoft.AspNetCore.Mvc.Route("identities/{name}")]
        public System.Threading.Tasks.Task<Identity> CreateIdentity(string api_version, string name)
        {
            return _implementation.CreateIdentityAsync(api_version, name);
        }
