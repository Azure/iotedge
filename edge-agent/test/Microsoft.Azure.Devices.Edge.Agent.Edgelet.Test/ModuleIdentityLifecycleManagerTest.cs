...
namespace Microsoft.Azure.Devices.Edge.Agent.Edgelet.Test
{
    ...
    public class ModuleIdentityLifecycleManagerTest
    {
        ...
        public async Task TestGetModulesIdentity_IIdentityManagerException_ShouldReturnEmptyIdentities()
        {
            ...
            var module1 = new TestModule("mod1", "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
            var module2 = new TestModule("mod2", "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
            var module3 = new TestModule("mod3", "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
            var module4 = new TestModule("$edgeHub", "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
        ...
        public async Task TestGetModulesIdentity_WithNewModules_ShouldCreateIdentities()
        {
            ...
            var moduleIdentityLifecycleManager = new ModuleIdentityLifecycleManager(identityManager, ModuleIdentityProviderServiceBuilder, EdgeletUri);
            var module = new TestModule(Name, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, new Dictionary<string, EnvVal>());
        ...
        public async Task TestGetModulesIdentity_WithUpdatedModules_ShouldUpdateIdentities()
        {
            ...
            var moduleIdentityLifecycleManager = new ModuleIdentityLifecycleManager(identityManager, ModuleIdentityProviderServiceBuilder, EdgeletUri);
            var envVar = new Dictionary<string, EnvVal>();
            var module1 = new TestModule(Module1, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
            var module2 = new TestModule(Module2, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
            var module3 = new TestModule(Module3, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
            var module4 = new TestModule(Module4, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
            var module5 = new TestModule(Module5, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
        ...
        public async Task TestGetModulesIdentity_WithRemovedModules_ShouldRemove()
        {
            ...
            var moduleIdentityLifecycleManager = new ModuleIdentityLifecycleManager(identityManager, ModuleIdentityProviderServiceBuilder, EdgeletUri);
            var envVar = new Dictionary<string, EnvVal>();
            var desiredModule = new TestModule(Module1, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
            var currentModule1 = new TestModule(Module2, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
            var currentModule2 = new TestModule(Module3, "v1", "test", ModuleStatus.Running, new TestConfig("image"), RestartPolicy.OnUnhealthy, PullPolicy.IfNotPresent, DefaultConfigurationInfo, envVar);
