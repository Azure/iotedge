        ...
        public async Task SmokeTest()
        {
            ...
            try
            {
                using (var cts = new CancellationTokenSource(this.defaultTimeout))
                {
                    ...
                    var module = new DockerModule(Name, "1.0", ModuleStatus.Running, global::Microsoft.Azure.Devices.Edge.Agent.Core.RestartPolicy.OnUnhealthy, config, PullPolicy.None, null, EnvVars);
        ...
        public async Task TestUdpModuleConfig()
        {
            ...
            try
            {
                using (var cts = new CancellationTokenSource(this.defaultTimeout))
                {
                    ...
                    var module = new DockerModule(Name, "1.0", ModuleStatus.Running, global::Microsoft.Azure.Devices.Edge.Agent.Core.RestartPolicy.OnUnhealthy, config, PullPolicy.IfNotPresent, null, EnvVars);
        ...
        public async Task EdgeHubLaunch()
        {
            ...
            try
            {
                using (var cts = new CancellationTokenSource(this.defaultTimeout))
                {
                    ...
                    var module = new EdgeHubDockerModule("docker", ModuleStatus.Running, global::Microsoft.Azure.Devices.Edge.Agent.Core.RestartPolicy.Always, config, PullPolicy.Never, configurationInfo, EnvVars);
        ...
        public async Task EdgeHubLaunchWithBadLogOptions()
        {
            ...
            try
            {
                using (var cts = new CancellationTokenSource(this.defaultTimeout))
                {
                    ...
                    var module = new EdgeHubDockerModule("docker", ModuleStatus.Running, global::Microsoft.Azure.Devices.Edge.Agent.Core.RestartPolicy.Always, config, PullPolicy.IfNotPresent, configurationInfo, EnvVars);
