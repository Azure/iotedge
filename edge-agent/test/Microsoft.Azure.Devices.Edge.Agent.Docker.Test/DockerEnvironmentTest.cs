...
namespace Microsoft.Azure.Devices.Edge.Agent.Docker.Test
{
    ...
    public class DockerEnvironmentTest
    {
        ...
        public async Task GetModulesTest()
        {
            ...
            var module1 = new DockerModule("module1", "v1", ModuleStatus.Stopped, RestartPolicy.Always, new DockerConfig("mod1:v1", "{\"Env\":[\"foo=bar\"]}"), PullPolicy.Always, new ConfigurationInfo(), null);
            ...
            var edgeHubModule = new EdgeHubDockerModule("docker", ModuleStatus.Running, RestartPolicy.Always, new DockerConfig("edgehub:v1", "{\"Env\":[\"foo3=bar3\"]}"), PullPolicy.Always, new ConfigurationInfo(), null);
            var edgeAgentModule = new EdgeAgentDockerModule("docker", new DockerConfig("edgeAgent:v1", string.Empty), PullPolicy.Always, new ConfigurationInfo(), null);
            var deploymentConfig = new DeploymentConfig(
                "1.0",
                new DockerRuntimeInfo("docker", new DockerRuntimeConfig(minDockerVersion, dockerLoggingOptions)),
            ...
            Assert.Equal(PullPolicy.Always, receivedDockerModule1.PullPolicy);
            ...
            Assert.Equal(PullPolicy.Never, receivedDockerModule2.PullPolicy);
            ...
            Assert.Equal(PullPolicy.Always, receivedDockerEdgeHub.PullPolicy);
            ...
            Assert.Equal(PullPolicy.Always, receivedDockerEdgeAgent.PullPolicy);
