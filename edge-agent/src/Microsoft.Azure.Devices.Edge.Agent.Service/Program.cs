            ...
            try
            {
                ...
                switch (mode.ToLowerInvariant())
                {
                    ...
                    case Constants.IotedgedMode:
                        ...
                        bool disableSeparePullFromCreateModule = configuration.GetValue<bool>(Constants.DisableSeparePullFromCreateModule, false);
