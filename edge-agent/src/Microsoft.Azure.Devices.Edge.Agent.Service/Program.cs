            ...
            try
            {
                ...
                switch (mode.ToLowerInvariant())
                {
                    ...
                    case Constants.KubernetesMode:
                        ...
                        string edgeK8sObjectOwnerApiVersion = configuration.GetValue<string>(K8sConstants.EdgeK8sObjectOwnerApiVersion);
                        string edgeK8sObjectOwnerKind = configuration.GetValue<string>(K8sConstants.EdgeK8sObjectOwnerKind);
                        string edgeK8sObjectOwnerName = configuration.GetValue<string>(K8sConstants.EdgeK8sObjectOwnerName);
                        string edgeK8sObjectOwnerUid = configuration.GetValue<string>(K8sConstants.EdgeK8sObjectOwnerUid);
