...
namespace Microsoft.Azure.Devices.Edge.Agent.IoTHub.ConfigSources
{
    ...
    public class TwinConfigSource : BaseConfigSource, ITwinConfigSource
    {
            ...
            : base(configuration)
        {
            ...
            this.ReportedModuleSet = ModuleSet.Empty;
        ...
        // Properties to track current module set and connection status
        internal ModuleSet CurrentModuleSet { get; set; }
        public ModuleSet ReportedModuleSet { get; internal set; }
            ...
            if ((this.ConnectionStatus != ConnectionStatus.Connected) && (status == ConnectionStatus.Connected))
            {
                try
                {
                    ...
                    while (refreshTwin)
                    {
                        ...
                        this.ReportedModuleSet = this.ModuleSetSerde.Deserialize(twin.Properties.Reported.ToJson());
