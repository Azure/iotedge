...
namespace Microsoft.Azure.Devices.Edge.Agent.Docker
{
    ...
    public class DockerReportedConfig : DockerConfig, IEquatable<DockerReportedConfig>
    {
        ...
        class DockerReportedConfigJsonConverter : JsonConverter
        {
            ...
            {
                Console.WriteLine("DockerReprotedConfig Serialization");
                ...
                {
                    Console.WriteLine("Digest DockerReportedConfig Serialization");
            ...
            public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
            {
                ...
                Console.WriteLine("DockerReprotedConfig Deserialization");
