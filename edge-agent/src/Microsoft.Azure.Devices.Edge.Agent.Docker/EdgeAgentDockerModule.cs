...
namespace Microsoft.Azure.Devices.Edge.Agent.Docker
{
    ...
    {
        [JsonConstructor]
        public EdgeAgentDockerModule(string type, DockerConfig settings, PullPolicy pullPolicy, ConfigurationInfo configuration, IDictionary<string, EnvVal> env, string version = "")
            : base(Core.Constants.EdgeAgentModuleName, version, ModuleStatus.Running, RestartPolicy.Always, settings, pullPolicy, configuration, env)
        {
