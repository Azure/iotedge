...
#pragma warning disable // Disable all warnings
    ...
    public partial class EdgeletHttpClient
    {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<ModuleSpec> CreateModuleAsync(string api_version, ModuleSpec module)
        {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<ModuleSpec> CreateModuleAsync(string api_version, ModuleSpec module, System.Threading.CancellationToken cancellationToken)
        {
            if (api_version == null)
                throw new System.ArgumentNullException("api_version");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(ModuleSpec);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<ModuleSpec>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Identity> CreateIdentityAsync(string api_version, string name, IdentitySpec identity)
        {
            return CreateIdentityAsync(api_version, name, identity, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<Identity> CreateIdentityAsync(string api_version, string name, IdentitySpec identity, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
    ...
    {
        private System.Collections.ObjectModel.ObservableCollection<ModuleDetails> _modules;
    ...
    {
        private System.Collections.ObjectModel.ObservableCollection<Identity> _identities;
