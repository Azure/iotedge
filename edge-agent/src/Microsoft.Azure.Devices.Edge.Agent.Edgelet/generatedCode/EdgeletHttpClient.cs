...
#pragma warning disable // Disable all warnings
    ...
    public partial class EdgeletHttpClient
    {
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Identity> UpdateIdentityAsync(string api_version, IdentitySpec identity)
        {
            return UpdateIdentityAsync(api_version, identity, System.Threading.CancellationToken.None);
        }
        ...
        /// <param name="identity"></param>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<Identity> UpdateIdentityAsync(string api_version, IdentitySpec identity, System.Threading.CancellationToken cancellationToken)
        {
            if (api_version == null)
                throw new System.ArgumentNullException("api_version");
        ...
        /// <param name="api_version">The version of the API.</param>
        /// <param name="name">The name of the identity to create. (urlencoded)</param>
        /// <returns>Created</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Identity> CreateIdentityAsync(string api_version, string name)
        {
            return CreateIdentityAsync(api_version, name, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<Identity> CreateIdentityAsync(string api_version, string name, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
