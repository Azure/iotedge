...
namespace Microsoft.Azure.Devices.Edge.Agent.Edgelet.Version_2020_07_22.GeneratedCode
{
    ...
    public partial class EdgeletHttpClient
    {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 403)
                        {
                            ...
                            throw new SwaggerException<ErrorResponse>("Forbidden", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 404)
                        {
                            ...
                            throw new SwaggerException<ErrorResponse>("NotFound", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ErrorResponse>(response_, headers_).ConfigureAwait(false);
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task PullSecretAsync(string api_version, string name, string secretId, string akvId)
        {
            return PullSecretAsync(api_version, name, secretId, akvId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task PullSecretAsync(string api_version, string name, string secretId, string akvId, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task RefreshSecretAsync(string api_version, string name, string secretId)
        {
            return RefreshSecretAsync(api_version, name, secretId, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task RefreshSecretAsync(string api_version, string name, string secretId, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 400)
                        {
                            ...
                            throw new SwaggerException<ErrorResponse>("NoSource", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 403)
                        {
