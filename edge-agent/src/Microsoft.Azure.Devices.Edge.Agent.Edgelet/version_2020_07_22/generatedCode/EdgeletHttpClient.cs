...
namespace Microsoft.Azure.Devices.Edge.Agent.Edgelet.Version_2020_07_22.GeneratedCode
{
    ...
    public partial class EdgeletHttpClient
    {
        ...
        /// <param name="api_version">The version of the API.</param>
        /// <param name="name">The name of the secret to fetch. (urlencoded)</param>
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<string> GetSecretAsync(string api_version, string name)
        {
            return GetSecretAsync(api_version, name, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<string> GetSecretAsync(string api_version, string name, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/secrets/{name}?");
            urlBuilder_.Replace("{name}", System.Uri.EscapeDataString(ConvertToString(name, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Append(System.Uri.EscapeDataString("api-version") + "=").Append(System.Uri.EscapeDataString(ConvertToString(api_version, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ErrorResponse>(response_, headers_).ConfigureAwait(false);
                            throw new SwaggerException<ErrorResponse>("NotFound", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ErrorResponse>(response_, headers_).ConfigureAwait(false);
        ...
        /// <param name="api_version">The version of the API.</param>
        /// <param name="name">The name of the secret to set. (urlencoded)</param>
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ErrorResponse>(response_, headers_).ConfigureAwait(false);
                            throw new SwaggerException<ErrorResponse>("Forbidden", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ErrorResponse>(response_, headers_).ConfigureAwait(false);
        ...
        /// <summary>Pull secret value from Azure Key Vault.</summary>
        /// <param name="api_version">The version of the API.</param>
        /// <param name="name">The name of the secret to pull. (urlencoded)</param>
        ...
        public async System.Threading.Tasks.Task PullSecretAsync(string api_version, string name, string akvId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (akvId == null)
                throw new System.ArgumentNullException("akvId");
        ...
        /// <summary>Refresh secret.</summary>
        /// <param name="api_version">The version of the API.</param>
        /// <param name="name">The name of the secret to refresh. (urlencoded)</param>
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task RefreshSecretAsync(string api_version, string name)
        {
            return RefreshSecretAsync(api_version, name, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task RefreshSecretAsync(string api_version, string name, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ErrorResponse>(response_, headers_).ConfigureAwait(false);
                            throw new SwaggerException<ErrorResponse>("NoSource", (int)response_.StatusCode, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == "404")
                        {
        ...
        /// <param name="api_version">The version of the API.</param>
        /// <param name="name">The name of the secret to delete. (urlencoded)</param>
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task DeleteSecretAsync(string api_version, string name)
        {
            return DeleteSecretAsync(api_version, name, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Ok</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task DeleteSecretAsync(string api_version, string name, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
