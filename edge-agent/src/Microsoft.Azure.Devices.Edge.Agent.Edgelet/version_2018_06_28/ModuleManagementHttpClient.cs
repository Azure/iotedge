...
namespace Microsoft.Azure.Devices.Edge.Agent.Edgelet.Version_2018_06_28
{
    using System;
    ...
    class ModuleManagementHttpClient : ModuleManagementHttpClientVersioned
    {
        ...
        public override Task<System.IO.Stream> GetSupportBundle(Option<string> since, Option<bool> edgeRuntimeOnly, CancellationToken token)
        {
