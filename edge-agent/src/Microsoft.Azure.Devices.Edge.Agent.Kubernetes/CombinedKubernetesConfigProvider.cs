...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes
{
    ...
    public class CombinedKubernetesConfigProvider : ICombinedConfigProvider<CombinedDockerConfig>, ICombinedConfigProvider<CombinedKubernetesConfig>
    {
        ...
        public CombinedKubernetesConfigProvider(IEnumerable<global::Docker.DotNet.Models.AuthConfig> authConfigs, IConfigSource configSource)
        {
        ...
        CombinedKubernetesConfig ICombinedConfigProvider<CombinedKubernetesConfig>.GetCombinedConfig(IModule module, IRuntimeInfo runtimeInfo)
        {
            ...
            // if (this.features.EnableKubernetesExtensions)
            // {
            //     createOptions.NodeSelector = ;
            //     createOptions.Resources = ;
            // }

            Option<Kubernetes.AuthConfig> authConfig = dockerConfig.AuthConfig
                .Map(auth => new Kubernetes.AuthConfig(ImagePullSecretName.Create(auth)));
    ...
    // public class CombinedKubernetesConfigProvider1 : CombinedDockerConfigProvider
    // {
    //     readonly IConfigSource configSource;
    //
