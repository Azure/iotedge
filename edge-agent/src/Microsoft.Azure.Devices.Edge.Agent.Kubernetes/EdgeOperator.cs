...
namespace Microsoft.Azure.Devices.Edge.Agent.Kubernetes
{
    ...
    public class EdgeOperator : IKubernetesOperator, IRuntimeInfoProvider
    {
            ...
            IKubernetes client)
        {
            ...
            this.deploymentSerde = new TypeSpecificSerDe<EdgeDeploymentDefinition>(deserializerTypesMap);
        ...
        public Task<Stream> GetModuleLogs(string module, bool follow, Option<int> tail, Option<int> since, CancellationToken cancellationToken) => throw new NotImplementedException();
                        ...
                        case WatchEventType.Deleted:
                            {
                                ...
                                IEnumerable<Task<V1Status>> removeDeploymentTasks = currentDeployments.Items.Select(
                                    d => this.client.DeleteNamespacedDeployment1Async(d.Metadata.Name, KubeUtils.K8sNamespace,
                                        new V1DeleteOptions(propagationPolicy: "Foreground"),  propagationPolicy: "Foreground"));
