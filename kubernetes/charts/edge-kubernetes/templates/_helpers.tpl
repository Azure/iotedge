...
agent:
  ...
  env:
    ...
    ExperimentalFeatures__Enabled: {{ .Values.edgeAgent.env.enableExperimentalFeature | quotes }}
    {{- end }}
    {{- if .Values.edgeAgent.env.enableK8sExtensions }}
    ExperimentalFeatures__EnableK8SExtensions: {{ .Values.edgeAgent.env.enableK8sExtension | quotes }}
    {{- end }}
  {{ else }}
  env: {}
  {{ end }}
